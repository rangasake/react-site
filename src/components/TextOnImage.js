...
=======
  className="image relative block overflow-hidden  rounded-xl shadow-xl hover:shadow-xl bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${Toi.imageUrl})` }}>
  <div className="absolute inset-0 bg-black/5 hover:bg-gray"></div>

  <div className="relative flex items-start justify-between p-4 sm:p-6 lg:p-4">
    <div className="sm:pt-18 pt-12 text-white lg:pt-16">
      <h3 className="text-lg font-bold sm:text-lg bg-black/30 p-1 rounded">{Toi.country}</h3>
>>>>>>> main
...
=======
      className="inline-flex items-center gap-1 rounded-full bg-sky-500 px-2  text-sm font-semibold text-white"
>>>>>>> main
    >
     {Toi.rating}
